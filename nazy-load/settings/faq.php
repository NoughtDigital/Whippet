...
?>
    ...
    <p>Every time you open a page, the HTML is parsed by the lazy loading module. This consumes a little memory and CPU. So to avoid it, it is highly recommended to use a cache plugin.</p>

    <h3>Why some background images are not lazy loaded?</h3>
    <p>Only background images that are inlined in HTML (e.g. <code>style="background-image:url('...')"</code>) can be lazy loaded.</p>
